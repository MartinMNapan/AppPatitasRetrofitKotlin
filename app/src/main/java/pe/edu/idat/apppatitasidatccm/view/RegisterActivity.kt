...
import pe.edu.idat.apppatitasidatccm.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        authViewModel.responseRegister.observe(this, Observer {
    ...
    private fun obtenerResultadoRegistro(response: ResponseRegister){
        if (response.rpta){
            setearControles()
